 ...
 */
package co.unicauca.labSpring.controllers;

import co.unicauca.labSpring.entities.Persona;
import co.unicauca.labSpring.services.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> getAll(){
        try{
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"error\":\"Erro. por favor intente mas tarde.\"}");
        }
    }
    ...
    public ResponseEntity<?> save(@RequestBody Persona entity){
        try{
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"error\":\"Erro. por favor intente mas tarde.\"}");
        }
    }
